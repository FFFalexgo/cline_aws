...
export default defineConfig({
	test: {
		...
		// workspace packages (@bedrock-coder/core/@bedrock-coder/llms/@bedrock-coder/shared), and on loaded
	...
	resolve: {
		alias: {
			"@bedrock-coder/core": path.resolve(__dirname, "src/test/bedrock-coder-core-vitest-stub.ts"),
			"@bedrock-coder/llms": path.resolve(__dirname, "node_modules/@bedrock-coder/llms/dist/index.js"),
			// Map @bedrock-coder/shared subpath exports explicitly. The bare "@bedrock-coder/shared"
			// alias below does not cover subpaths (e.g. "@bedrock-coder/shared/storage"), and
			...
			"@bedrock-coder/shared/storage": path.resolve(__dirname, "node_modules/@bedrock-coder/shared/dist/storage/index.js"),
			"@bedrock-coder/shared": path.resolve(__dirname, "node_modules/@bedrock-coder/shared/dist/index.js"),
			...
			"@shared/proto/bedrock_coder/common": path.resolve(__dirname, "src/shared/proto/bedrock_coder/common.ts"),
			"@shared/proto/bedrock_coder/models": path.resolve(__dirname, "src/shared/proto/bedrock_coder/models.ts"),
